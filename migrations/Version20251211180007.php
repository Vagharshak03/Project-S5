 ...
 */
final class Version20251211180007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ALTER fullname TYPE VARCHAR(150)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users ALTER fullname TYPE VARCHAR(255)');
